...
def eval_model(args):
    ...
    images = load_images(["data/OctoGibson/all_data_images/buy_a_keg_cashlessly_fail/subtask_2/rgb1_detect_surroundings.png","data/OctoGibson/all_data_images/buy_a_keg_cashlessly_fail/subtask_2/rgb4_detect_surroundings.png"])
