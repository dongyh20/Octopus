...
#     "luodian/OTTER-9B-DenseCaption", device_map={"": device_id}, torch_dtype=torch.bfloat16,
# )

model = OtterForConditionalGeneration.from_pretrained(
    "checkpoints/Otter_MPT7B_EAI_2024-03-08-02-35-25", device_map={"": device_id}, torch_dtype=torch.bfloat16,
)


# model = OtterForConditionalGeneration.from_pretrained(
#     "./model/Otter-EAI-Tester", device_map='sequential', torch_dtype=torch.bfloat16,
# )
