...
################## project ##################
PROJECT_NAME="llava-vicuna_7B-mlp2x_gelu-pretrain_blip558k_plain-ft-video_image_mix-frames_upbound_${FRAMES_UPBOUND}-pool_stride_${POOL_STRIDE}-model_max_length_${MODEL_MAX_LENGTH}"
...
deepspeed --master_port 29501 llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /mnt/bn/vl-research/checkpoints/projectors/ds_llava-vicuna-7b-v1-5-clip_large_224px-mlp2x_gelu-pretrain_blip558k_plain/mm_projector.bin \
