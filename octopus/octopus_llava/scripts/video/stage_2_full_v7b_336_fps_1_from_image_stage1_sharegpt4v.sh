...
################## project ##################
PROJECT_NAME=llava-vicuna_7B-mlp2x_gelu-pretrain_blip558k_plain-336px-ft-video_image_mix-frames_upbound_${FRAMES_UPBOUND}-pool_stride_${POOL_STRIDE}-model_max_length_${MODEL_MAX_LENGTH}-dist1-mix_sharevideogpt4v
...
deepspeed --master_port 30000 llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /mnt/bn/vl-research/data/llava_video/meta/finetune/llava_158k_detailv3_reinstall_gpt4v24k_wild15k_mixdocvqa_fixdca30k_fixsynden40k_sg40kt2k_ori_with_sharevideogptv.json \
