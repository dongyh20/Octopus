...
################## project ##################
PROJECT_NAME="llava-vicuna_7B-mlp2x_gelu-llava_558k_with_webvid-spatial_pool4-video_fps1-ft-video_image_mix"
...
deepspeed --master_port 29501 llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path ./data/LLaMA-VID-Finetune/llava_158k_detailv3_reinstall_gpt4v24k_wild15k_mixdocvqa_fixdca30k_fixsynden40k_sg40kt2k_ori.json \
    --image_folder ./data/LLaMA-VID-Finetune/ \
    --vision_tower  openai/clip-vit-large-patch14 \
    --pretrain_mm_mlp_adapter /mnt/bn/vl-research/workspace/yhzhang/LLaVA_dev/work_dirs/llava-vicuna_7B-mlp2x_gelu-llava_558k_with_webvid-spatial_pool4-video_fps1-pt/mm_projector.bin \
