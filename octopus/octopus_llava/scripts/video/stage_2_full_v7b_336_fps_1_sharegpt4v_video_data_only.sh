...
################## project ##################
PROJECT_NAME=llava-vicuna_7B-mlp2x_gelu-pretrain_blip558k_plain-336px-ft-video_image_mix-frames_upbound_${FRAMES_UPBOUND}-pool_stride_${POOL_STRIDE}-model_max_length_${MODEL_MAX_LENGTH}-dist1-sharevideogpt4v
...
deepspeed --master_port 30000 llava/train/train_mem.py \
    ...
    --model_name_or_path /mnt/bn/vl-research/checkpoints/llava-1.6-vicuna-7b \
    --version v1 \
    --data_path /mnt/bn/vl-research/data/llava_video/meta/finetune/sharevideogptv.json \
