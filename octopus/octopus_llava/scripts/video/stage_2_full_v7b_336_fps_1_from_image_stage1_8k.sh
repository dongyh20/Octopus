...
deepspeed --master_port 30000 llava/train/train_mem.py \
    ...
    --model_name_or_path /mnt/bn/vl-research/checkpoints/vicuna/vicuna-7b-v1-5-8k \
    --version v1 \
    ...
    --image_grid_pinpoints "[(336, 672), (672, 336), (672, 672), (1008, 336), (336, 1008), (672, 1008), (1008, 672), (1008, 1008), (1008, 1344), (1344, 1008)]" \
