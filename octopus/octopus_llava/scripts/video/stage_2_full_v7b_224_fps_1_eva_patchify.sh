...
################## project ##################
PROJECT_NAME="llava-vicuna_7B-eva-mlp2x_gelu-llava_558k_with_webvid-spatial_pool4-video_fps1-patchify-ft"
...
deepspeed --master_port 29501 llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter ./work_dirs/llava-vicuna_7B-eva-mlp2x_gelu-llava_558k_with_webvid-spatial_pool4-video_fps1-pt/mm_projector.bin \
    ...
    --mm_spatial_pool_out_channels 1408 \
