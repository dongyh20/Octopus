...
################## project ##################
PROJECT_NAME=llava-vicuna_7B-mlp2x_gelu-llava_558k_with_webvid-spatial_pool4-video_fps1-ft-video_image_mix-frames_upbound_${FRAMES_UPBOUND}-pool_stride_${POOL_STRIDE}-model_max_length_${MODEL_MAX_LENGTH}
