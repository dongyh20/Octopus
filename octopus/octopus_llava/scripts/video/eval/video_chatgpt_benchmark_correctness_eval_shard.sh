#!/bin/bash
ROOT_DIR="/mnt/bn/vl-research/workspace/yhzhang/llava-video-old"
cd $ROOT_DIR
...
#     echo "CUDA_VISIBLE_DEVICES=$CHUNK_GPUS_STR"
#     CUDA_VISIBLE_DEVICES=$CHUNK_GPUS_STR python3 llavavid/eval/model_video_chatgpt_general.py \
#         --model-path $CKPT \
#         --video_dir ./data/llava_video/video-chatgpt/evaluation/Test_Videos/ \
...
#     echo "CUDA_VISIBLE_DEVICES=$CHUNK_GPUS_STR"
#     CUDA_VISIBLE_DEVICES=$CHUNK_GPUS_STR python3 llavavid/eval/model_video_chatgpt_consistency.py \
#         --model-path $CKPT \
#         --video_dir ./data/llava_video/video-chatgpt/evaluation/Test_Videos/ \
