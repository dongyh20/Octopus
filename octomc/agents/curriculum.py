...
class Octopus_CurriculumAgent:
    ...
    def propose_next_ai_task(self, *, messages, max_retries=5):
        ...
        curriculum = self.gpt_request(all_message).content
    ...
    def decompose_task(self, task, events):
        ...
        all_message=messages[0].content+messages[1].content
        response = self.gpt_request(all_message).content
    ...
    def run_qa_step1_ask_questions(self, *, events, chest_observation):
        ...
        all_message=messages[0].content+messages[1].content
        qa_response = self.gpt_request(all_message).content
    ...
    def run_qa_step2_answer_questions(self, question):
        ...
        all_message=messages[0].content+messages[1].content
        qa_answer = self.gpt_request(all_message).content
